<script>
  export let images = [
    { path: "/img/img1.jpg", description: "JC Ciobes" },
    { path: "/img/img2.jpg", description: "JC Ciobes" },
    { path: "/img/img3.jpg", description: "JC Ciobes" },
    { path: "/img/img4.jpg", description: "JC Ciobes" },
    { path: "/img/img5.jpg", description: "JC Ciobes" },
  ];
